...
- Високий (СЕО, СXX, музикант, атлет, артист, будь-яка небезпечна провесія, яка приносить хороші прибутки)
- Середній (інженер, програміст, бухгалтер, юрист, сейлз, маркетолог, менеджер, науковець, загалом 0 романтики)
- Низький (адміністратор, продавець, консультант, тех. підтримка, дом. робота тд)
